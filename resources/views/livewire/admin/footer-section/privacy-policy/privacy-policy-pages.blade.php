    ...
    <div>
        <div class="d-flex justify-content-between">
            ...
            <h5 class="card-header">
                <a class="btn btn-primary" href="{{ route('create.privacypolicy.page') }}">
            ...
            <div class="row">
                <div class="text-nowrap">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($privacy_policy_pages['privacy_policy_pages'] as $page)
                                <tr>
                                    <td> {{ $page->title }}</td>
                                    <td> {{ $page->page_language }}</td>
                                    <td>
                                        <a class="btn btn-warning btn-sm fw-bold"
                                            href="{{ route('edit.privacypolicy.page', $page->id) }}">
            ...
            <div class="row">
                <div class="col">
                    <div class="demo-inline-spacing">
                        @if ($privacy_policy_pages['privacy_policy_pages']->count() > 0)
                            {{ $privacy_policy_pages['privacy_policy_pages']->links() }}
                        @else
