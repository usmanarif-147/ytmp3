    ...
    <div>
        <div class="d-flex justify-content-between">
            <h2 class="card-header">
                <a href="{{ route('legaldisclaimerpages') }}"> Leagle Disclaimer Pages </a> / {{ $heading }}
            </h2>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div wire:ignore>
                                        <textarea class="form-control" id="description" wire:model.defer="description">
                                            {{ $description }}
                                        </textarea>
                                    </div>
                                </div>
    ...
    <script>
        window.addEventListener('swal:modal', event => {
            swal({
                ...
                location.href = "{{ route('legaldisclaimerpages') }}";
            });
        });
