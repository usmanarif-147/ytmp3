    ...
    <div>
        <div class="d-flex justify-content-between">
            ...
            <h5 class="card-header">
                <a class="btn btn-primary" href="{{ route('create.copyrightpages.page') }}">
            ...
            <div class="row">
                <div class="text-nowrap">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($copyright_act_pages['copyright_act_pages'] as $page)
                                <tr>
                                    <td> {{ $page->title }}</td>
                                    <td> {{ $page->page_language }}</td>
                                    <td>
                                        <a class="btn btn-warning btn-sm fw-bold"
                                            href="{{ route('edit.copyrightpages.page', $page->id) }}">
            ...
            <div class="row">
                <div class="col">
                    <div class="demo-inline-spacing">
                        @if ($copyright_act_pages['copyright_act_pages']->count() > 0)
                            {{ $copyright_act_pages['copyright_act_pages']->links() }}
                        @else
