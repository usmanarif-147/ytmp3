    ...
    <div>
        <div class="d-flex justify-content-between">
            ...
            <h5 class="card-header">
                <a class="btn btn-primary" href="{{ route('create.termofuse.page') }}">
                    Create Term of Use Page
                </a>
            </h5>
        </div>
    </div>
            ...
            <div class="row">
                <div class="text-nowrap">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($terms_of_use_pages['terms_of_use_pages'] as $page)
                                <tr>
                                    <td> {{ $page->title }}</td>
                                    <td> {{ $page->page_language }}</td>
                                    <td>
                                        <a class="btn btn-warning btn-sm fw-bold"
                                            href="{{ route('edit.termofuse.page', $page->id) }}">
            ...
            <div class="row">
                <div class="col">
                    <div class="demo-inline-spacing">
                        @if ($terms_of_use_pages['terms_of_use_pages']->count() > 0)
                            {{ $terms_of_use_pages['terms_of_use_pages']->links() }}
                        @else
